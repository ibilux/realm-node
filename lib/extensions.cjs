...
module.exports = function (realmConstructor) {
  ...
  Object.defineProperties(
    ...
    require('realm-node/lib/set-methods.cjs')(realmConstructor)
  );
  Object.defineProperties(
    realmConstructor.Collection.prototype,
    require('realm-node/lib/collection-methods.cjs')(realmConstructor)
  );
  realmConstructor.DictionaryProxy = require('realm-node/lib/dictionary.cjs').DictionaryProxy;
  ...
  if (realmConstructor.App.Sync) {
    let appMethods = require('realm-node/lib/app.cjs');
    ...
    let userMethods = require('realm-node/lib/user.cjs');
    ...
    let subscriptionSetMethods = require('realm-node/lib/subscription-set.cjs');
    Object.defineProperties(
    ...
    let mutableSubscriptionSetMethods = require('realm-node/lib/mutable-subscription-set.cjs');
    Object.defineProperties(
    ...
    let sessionMethods = require('realm-node/lib/session.cjs');
    Object.defineProperties(
    ...
    let credentialMethods = require('realm-node/lib/credentials.cjs');
    Object.defineProperties(
      realmConstructor.Credentials,
      getOwnPropertyDescriptors(credentialMethods.static)
    );

    let emailPasswordAuthMethods = require('realm-node/lib/email-password-auth-methods.cjs');
    Object.defineProperties(
      realmConstructor.Auth.EmailPasswordAuth.prototype,
      getOwnPropertyDescriptors(emailPasswordAuthMethods.instance)
    );

    let apiKeyAuthMethods = require('realm-node/lib/api-key-auth-methods.cjs');
    Object.defineProperties(
      realmConstructor.Auth.ApiKeyAuth.prototype,
      getOwnPropertyDescriptors(apiKeyAuthMethods.instance)
    );

    realmConstructor.App.Sync.AuthError = require('realm-node/lib/errors.cjs').AuthError;
