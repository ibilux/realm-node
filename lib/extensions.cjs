...
module.exports = function (realmConstructor) {
  ...
  Object.defineProperties(
    realmConstructor.Set.prototype,
    require('@ibilux/realm-node/lib/set-methods.cjs')(realmConstructor)
  );
  Object.defineProperties(
    realmConstructor.Collection.prototype,
    require('@ibilux/realm-node/lib/collection-methods.cjs')(realmConstructor)
  );
  realmConstructor.DictionaryProxy = require('@ibilux/realm-node/lib/dictionary.cjs').DictionaryProxy;
  ...
  if (realmConstructor.App.Sync) {
    let appMethods = require('@ibilux/realm-node/lib/app.cjs');
    Object.defineProperties(realmConstructor.App, getOwnPropertyDescriptors(appMethods.static));
    Object.defineProperties(
      realmConstructor.App.prototype,
      getOwnPropertyDescriptors(appMethods.instance)
    );

    let userMethods = require('@ibilux/realm-node/lib/user.cjs');
    Object.defineProperties(realmConstructor.User, getOwnPropertyDescriptors(userMethods.static));
    Object.defineProperties(
      realmConstructor.User.prototype,
      getOwnPropertyDescriptors(userMethods.instance)
    );

    let subscriptionSetMethods = require('@ibilux/realm-node/lib/subscription-set.cjs');
    Object.defineProperties(
    ...
    let mutableSubscriptionSetMethods = require('@ibilux/realm-node/lib/mutable-subscription-set.cjs');
    Object.defineProperties(
    ...
    let sessionMethods = require('@ibilux/realm-node/lib/session.cjs');
    Object.defineProperties(
      realmConstructor.App.Sync.Session,
      getOwnPropertyDescriptors(sessionMethods.static)
    );
    Object.defineProperties(
    ...
    let credentialMethods = require('@ibilux/realm-node/lib/credentials.cjs');
    Object.defineProperties(
      realmConstructor.Credentials,
      getOwnPropertyDescriptors(credentialMethods.static)
    );

    let emailPasswordAuthMethods = require('@ibilux/realm-node/lib/email-password-auth-methods.cjs');
    Object.defineProperties(
      realmConstructor.Auth.EmailPasswordAuth.prototype,
      getOwnPropertyDescriptors(emailPasswordAuthMethods.instance)
    );

    let apiKeyAuthMethods = require('@ibilux/realm-node/lib/api-key-auth-methods.cjs');
    Object.defineProperties(
      realmConstructor.Auth.ApiKeyAuth.prototype,
      getOwnPropertyDescriptors(apiKeyAuthMethods.instance)
    );

    realmConstructor.App.Sync.AuthError = require('@ibilux/realm-node/lib/errors.cjs').AuthError;
