...
function bindings() {
  const paths = [
    ...
    'node_modules/@ibilux/realm-node/build/realm.node',
    // node-waf and gyp_addon (a.k.a node-gyp)
    'node_modules/@ibilux/realm-node/build/Debug/realm.node',
    'node_modules/@ibilux/realm-node/build/Release/realm.node',
    // node-pre-gyp path ./lib/binding/{node_abi}-{platform}-{arch}
    'node_modules/@ibilux/realm-node/lib/binding/nodePreGyp/realm.node'
  ];
